  ...
  return (
    <AppBar position="fixed" open={open} drawerWidth={drawerWidth}>
      <Toolbar sx={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <Box sx={{ flexGrow: 0 }}>
          <IconButton component={Link} to="https://github.com/INTO-CPS-Association/DTaaS" size="large">
            <GitHubIcon fontSize="inherit"></GitHubIcon>
          </IconButton>
          <IconButton component={Link} to="https://into-cps-association.github.io/DTaaS" size="large">
